...
3. Deduplicate by owner:
   ...
   - `docs/standards/components.md` owns component boundaries and Vue code conventions.
   ...
   - `docs/standards/styling.md` owns CSS-first principles, Tailwind generic rules, and text truncation.
