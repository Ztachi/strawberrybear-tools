...
export default {
  ...
  registration: {
    ...
    previewDescription:
      '現在のプレビューは仮のベース画像を使用しています。正式なテンプレート詳細は後続で調整します。',
  },
  proofing: {
    title: '発行前校正 · 第二步',
    subtitle:
      '仮のベース画像で校正を確認します。上部の言語切替でテンプレート文字がすぐ切り替わり、入力した名前はそのまま残ります。',
    desktopPanel: 'デスクトップ編集パネル',
    mobileToolbar: 'モバイル下部ツールバー',
    previewTitle: '発行前校正',
    fieldEditor: '資料内容',
    templatePosition: 'テンプレート位置',
    positionTarget: '調整項目',
    positionX: '横位置',
    positionY: '縦位置',
    resetPosition: 'この項目を既定位置へ戻す',
    backRegistration: '登録資料へ戻る',
    saveHint: '調整は現在の下書きにすぐ保存されます。',
    apply: '正式発行を申請',
  },
  signing: {
    title: '発行式',
  ...
  assets: {
    ...
    emptyDescription: 'アップロード、トリミング、名前変更、選択フローはここに接続します。',
  },
} as const
