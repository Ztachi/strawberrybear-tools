...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::midi_projects::get_midi_projects,
            commands::midi_projects::load_midi_project,
            commands::midi_projects::save_midi_project,
            commands::midi_projects::delete_midi_project,
            commands::midi_projects::rename_midi_project,
            commands::midi_projects::import_midi_projects,
            commands::midi_projects::export_midi_project,
            commands::midi_projects::export_midi_projects_archive,
            commands::midi_projects::save_midi_project_draft,
            commands::midi_projects::load_midi_project_draft,
            commands::midi_projects::delete_midi_project_draft,
            commands::midi_projects::save_binary_file,
