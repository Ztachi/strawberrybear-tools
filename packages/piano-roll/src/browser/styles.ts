...
.pr-corner{background:var(--pr-surface-raised,#fff1f4);border-right:1px solid var(--pr-border,#f1d9de);border-bottom:1px solid var(--pr-border,#f1d9de);display:flex;align-items:center;padding:0 10px;overflow:hidden;white-space:nowrap}
...
.pr-gutter{position:relative;min-height:0;overflow:hidden;background:var(--pr-surface-subtle,#fffafb);border-right:1px solid var(--pr-border,#f1d9de);overscroll-behavior:contain}
...
.pr-track{position:absolute;left:0;right:0;box-sizing:border-box;display:flex;align-items:center;gap:6px;padding:10px;border-bottom:1px solid var(--pr-border,#f1d9de);background:var(--pr-surface-raised,#fff1f4)}
.pr-track[data-selected=true]{background:var(--pr-track-selected,#ffe2e8);box-shadow:inset 3px 0 var(--pr-primary,#e36f86)}
...
.pr-track-toggle{border:1px solid var(--pr-border,#f1d9de);border-radius:var(--pr-control-radius,6px);background:var(--pr-primary-soft,#f7b7be);color:var(--pr-text,#4a3f3f);cursor:pointer;padding:4px;font:inherit}
