...
.pr-track-toggle{border:0;border-radius:var(--pr-control-radius,6px);background:transparent;color:var(--pr-primary,#e36f86);cursor:pointer;padding:4px;font:inherit}
